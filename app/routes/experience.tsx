export default function Experience() {
  return (
    <section id="experience" className="m-3">
      <article>
        ...
        <h4 className="text-lg">Amazon Autos</h4>
        <p className="mt-2">
          ...
          credit applications via third party lenders, generating contracts, and
          supplementing the sales workflows! Insane hours, insane attention to
          detail but we got it done on time with pizzazz.
        </p>
        ...
        <aside>
          <h4 className="mt-3 text-lg">What did the boss think of my work?</h4>
          <p className="mt-3 border-l-2 border-l-blue-400 pl-3">
      ...
      <article className="mt-2">
        ...
        <article>
          ...
          <p>
            Amazon Auto launch! Yep, we built and managed the handling for the
            big A. Each and every vehicle that is sold on Amazon leverages code
            I wrote; processing credit applications via third party lenders!
            Insane hours, insane attention to details but we got it done on time
            with pizzazz.
          </p>
          <aside>
